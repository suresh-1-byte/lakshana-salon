...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-36 bg-[#f7f7f5] relative overflow-hidden">
      {/* Ambient */}
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-16">
            ...
            >
              ...
              <p className="text-[#4a5f7f] font-light leading-relaxed max-w-md text-base">
              ...
              {contactItems.map(({ icon: Icon, label, value, hoverBg }, i) => (
                ...
                >
                  ...
                  <div className="space-y-1 pt-1">
                    ...
                    <p className="text-sm text-[#4a5f7f] font-light leading-relaxed whitespace-pre-line">{value}</p>
                  </div>
                </motion.div>
              ))}
              ...
              >
                ...
                <div className="space-y-3 pt-1 w-full">
                  ...
                  <div className="flex justify-between items-center border-b border-[#d4af37]/[0.08] pb-2">
                    <span className="text-sm text-[#4a5f7f] font-light">Monday – Sunday</span>
                    <span className="text-sm text-[#1f355e] font-light">10:00 AM – 8:00 PM</span>
                  </div>
          ...
          <div className="space-y-7">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-[#1f355e]/50 z-10 pointer-events-none" />
