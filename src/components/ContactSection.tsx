        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-8">
              ...
              <motion.div
                ...
                className="flex items-start gap-5 group"
              >
                <div className="w-12 h-12 border border-[#D4447A]/22 flex items-center justify-center text-[#D4447A] group-hover:bg-[#F59E0B] group-hover:text-white group-hover:border-[#F59E0B] transition-all duration-500 shrink-0">
                  <Clock size={20} strokeWidth={1.3} />
                </div>
                <div className="space-y-3 pt-1 w-full">
                  <h4 className="text-[10px] font-bold uppercase tracking-[0.42em] text-[#D4447A]">Business Hours</h4>
                  <div className="flex justify-between items-center border-b border-[#D4447A]/[0.08] pb-2">
                  ...
                  <p className="text-[9px] text-[#D4447A]/70 tracking-[0.38em] uppercase font-bold">Open All Days</p>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="space-y-7">
            ...
            <motion.div
              ...
              style={{ border: '1px solid rgba(212,68,122,0.25)' }}
            >
              <Image
              ...
              <div className="absolute bottom-6 left-6 z-20">
                <p className="text-[9px] uppercase tracking-[0.5em] text-[#E8A0B4] font-bold">Our Welcoming Space</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ border: '1px solid rgba(212,68,122,0.12)' }}
            >
              <iframe
