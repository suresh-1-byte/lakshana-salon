...
const inputClass =
  'bg-white border border-[rgba(212,175,55,0.2)] rounded-xl h-12 text-[#1f355e] placeholder:text-[#B89BAA]/70 font-light tracking-[0.04em] text-sm transition-all duration-300 focus:border-[rgba(212,175,55,0.55)] focus:ring-0 focus:shadow-[0_0_0_2px_rgba(212,175,55,0.10)]';
...
export function BookingSection() {
  ...
  return (
    <section id="appointment" className="py-24 bg-[#f7f7f5] overflow-hidden relative">
      {/* Ambient blobs */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-3xl">
        ...
        >
          ...
          <h2 className="font-headline font-light leading-tight text-[#1f355e]"
          ...
          <p className="text-[#4a5f7f] font-light max-w-md mx-auto leading-relaxed">
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: '0 16px 60px rgba(31,53,94,0.09)',
          }}
        >
          {/* Pink top shimmer */}
              ...
              <div className="relative">
                ...
                >
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-sm text-[#1f355e] placeholder:text-[#B89BAA] outline-none"
                  />
                  {search && (
                ...
                <AnimatePresence>
                  {dropOpen && (
                    <motion.div
                      ...
                      className="absolute left-0 right-0 top-full mt-2 z-50 rounded-2xl overflow-hidden shadow-[0_16px_48px_rgba(31,53,94,0.15)]"
                              ...
                              <div key={cat.id}>
                                ...
                                {catServices.map((svc) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      <div>
                                        <p className={`text-sm ${already ? 'text-[#B89BAA]' : 'text-[#1f355e]'}`}>{svc.name}</p>
                ...
                {cart.length > 0 && (
                  ...
                  >
                    {cart.map((svc, i) => (
                      ...
                      >
                        <div>
                          <p className="text-sm font-medium text-[#1f355e]">{svc.name}</p>
        ...
        {confirmed && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 z-[100] bg-[#1f355e]/50 backdrop-blur-sm"
              onClick={resetForm}
            />
            ...
            >
              <div
                ...
                style={{
                  background: 'linear-gradient(145deg,#fff 0%,#f7f7f5 100%)',
                  border: '1px solid rgba(212,175,55,0.2)',
                  boxShadow: '0 32px 80px rgba(31,53,94,0.2)',
                }}
              >
                {/* Pink top bar */}
                ...
                <div className="p-10 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-headline text-[2rem] font-medium text-[#1f355e]">Booking Confirmed!</h3>
                    <p className="text-[#4a5f7f] text-sm font-light leading-relaxed">
                      Thank you, <span className="font-medium text-[#d4af37]">{name}</span>!<br />
                      Our team will call you on <span className="font-medium text-[#1f355e]">{phone}</span> shortly to confirm your appointment.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl p-4 space-y-2 text-left"
                    ...
                    {cart.map((svc) => (
                      <div key={svc.name} className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-xs font-medium text-[#1f355e]">{svc.name}</p>
