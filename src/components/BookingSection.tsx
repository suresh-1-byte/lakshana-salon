...
const inputClass =
  'bg-white border border-[rgba(212,68,122,0.2)] rounded-xl h-12 text-[#2D1B25] placeholder:text-[#B89BAA]/70 font-light tracking-[0.04em] text-sm transition-all duration-300 focus:border-[rgba(212,68,122,0.55)] focus:ring-0 focus:shadow-[0_0_0_2px_rgba(212,68,122,0.10)]';
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-3xl">
        ...
        <motion.div
          ...
          style={{
            ...
            border: '1px solid rgba(212,68,122,0.16)',
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-10 space-y-7">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-[0.38em] font-bold text-[#D4447A]">Full Name</label>
                <Input required value={name} onChange={(e) => setName(e.target.value)}
                  placeholder="Your name" className={inputClass} />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-[0.38em] font-bold text-[#D4447A]">Phone</label>
            ...
            <div className="space-y-3">
              <label className="text-[10px] uppercase tracking-[0.38em] font-bold text-[#D4447A] block">
                Select Services
              </label>
              ...
              <div className="relative">
                <div
                  ...
                  style={{
                    background: 'white',
                    border: `1px solid ${dropOpen ? 'rgba(212,68,122,0.5)' : 'rgba(212,68,122,0.2)'}`,
                    boxShadow: dropOpen ? '0 0 0 2px rgba(212,68,122,0.10)' : 'none',
                  }}
                  onClick={() => setDropOpen(true)}
                >
                  <Plus size={14} className="text-[#D4447A] shrink-0" />
                  <input
                    type="text"
                  ...
                  {search && (
                    <button type="button" onClick={() => { setSearch(''); setDropOpen(false); }}>
                      <X size={13} className="text-[#B89BAA] hover:text-[#D4447A]" />
                    </button>
                  )}
                </div>
                ...
                <AnimatePresence>
                  {dropOpen && (
                    <motion.div
                      ...
                      style={{ border: '1px solid rgba(212,68,122,0.18)', background: 'white', maxHeight: '280px', overflowY: 'auto' }}
                                ...
                                {catServices.map((svc) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      disabled={already}
                                      className="w-full flex items-center justify-between px-4 py-2.5 text-left hover:bg-[rgba(212,68,122,0.04)] transition-colors duration-150"
                                    >
                                      <div>
                                      ...
                                      {already
                                        ...
                                        : <Plus size={13} className="text-[#D4447A] shrink-0" />
                                      }
                                    </button>
                                  );
                                })}
                    ...
                    {cart.map((svc, i) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-[10px] text-[#B89BAA] mt-0.5">{svc.category} • {svc.duration} • <span style={{ color: '#D4447A' }}>{svc.member}</span></p>
                        </div>
                        <button type="button" onClick={() => removeService(svc.name)}
                          className="w-7 h-7 rounded-full flex items-center justify-center hover:bg-[rgba(212,68,122,0.15)] transition-colors">
                          <X size={13} className="text-[#D4447A]" />
                        </button>
                      </motion.div>
                    ))}
                  </motion.div>
            ...
            <Button
              ...
              style={{
                ...
                boxShadow: cart.length > 0 ? '0 0 30px rgba(212,68,122,0.35)' : 'none',
              }}
            >
              {loading
        ...
        {confirmed && (
          <>
            ...
            >
              ...
              >
                {/* Pink top bar */}
                <div className="h-[4px]" style={{ background: 'linear-gradient(90deg,#D4447A,#E8A0B4,#D4447A)' }} />
                ...
                <div className="p-10 space-y-6">
                  ...
                  <motion.div
                    ...
                    style={{ background: 'linear-gradient(135deg,#D4447A,#E8A0B4)', boxShadow: '0 8px 32px rgba(212,68,122,0.45)' }}
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[#7B4F62] text-sm font-light leading-relaxed">
                      Thank you, <span className="font-medium text-[#D4447A]">{name}</span>!<br />
                  ...
                  <div className="rounded-2xl p-4 space-y-2 text-left"
                    ...
                    <p className="text-[9px] font-bold uppercase tracking-[0.35em] text-[#D4447A] mb-2.5">Your Selected Services</p>
                    {cart.map((svc) => (
