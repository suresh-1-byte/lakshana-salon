...
const values = [
  ...
  { title: 'Passion',     desc: 'Striving for perfection.',                icon: Sparkles,   initial: 'P', hoverBg: '#d4af37', hoverText: '#ffffff', hoverShadow: 'rgba(212,175,55,0.45)' },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-28 space-y-7">
          ...
          <motion.h2 initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
            ...
            className="font-headline font-light leading-tight text-[#1f355e]"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <blockquote className="border-l-[2px] border-[#d4af37]/40 pl-8 py-2">
                <p className="text-[#1f355e] text-xl font-headline italic leading-relaxed">
                  &ldquo;Founded on a passion for beauty, continuous learning, and a commitment to excellence.&rdquo;
                </p>
              </blockquote>

              <p className="text-[#4a5f7f] leading-relaxed font-light text-base">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#1f355e]/50 z-10 pointer-events-none" />
        ...
        <div className="pt-24 border-t border-[rgba(212,175,55,0.08)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {values.map((v, i) => (
              ...
              >
                {/* Ghost letter */}
                <span className="absolute -top-3 -right-3 text-[7rem] font-headline font-bold text-[#d4af37]/[0.04] pointer-events-none select-none leading-none group-hover:text-[#d4af37]/[0.08] transition-colors duration-700">
                  {v.initial}
                </span>

                {/* Icon — each card gets its own hover colour */}
                <div
                  className="w-16 h-16 rounded-full border border-[#d4af37]/20 flex items-center justify-center text-[#d4af37] transition-all duration-500 relative z-10"
                  style={
                    {
                      '--hover-bg': v.hoverBg,
                ...
                <div className="space-y-3 relative z-10">
                  <h5 className="text-[10px] font-bold uppercase tracking-[0.42em] text-[#d4af37] group-hover:text-[#1f355e] transition-colors duration-[400ms]">
                    {v.title}
                  </h5>
                  <p className="text-[11px] text-[#4a5f7f] uppercase tracking-[0.18em] font-light leading-relaxed">
                    {v.desc}
                  </p>
                </div>
