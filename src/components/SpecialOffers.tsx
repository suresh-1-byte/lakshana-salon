      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24 space-y-6">
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
            ...
            className="text-[#4a5f7f] font-light max-w-xl mx-auto leading-relaxed italic">
          ...
          {offers.map((offer, index) => (
            <motion.div
              ...
              style={{
                ...
                boxShadow: offer.bestseller
                  ? '0 0 40px rgba(212,175,55,0.10), 0 12px 40px rgba(31,53,94,0.10)'
                  : '0 8px 30px rgba(31,53,94,0.07)',
            ...
            >
              ...
              <div className="p-9 pt-12 flex flex-col flex-1 space-y-7">
                {/* Title */}
                <h3 className="text-[11px] font-bold uppercase tracking-[0.26em] text-[#d4af37] leading-relaxed group-hover:text-[#1f355e] transition-colors duration-[400ms]">
                  {offer.title}
                </h3>

                {/* Price */}
                <div className="space-y-1">
                  <div className="font-headline text-[2.6rem] font-light text-[#1f355e] leading-none">
                    ₹{offer.price}
                  </div>
                ...
                {/* Services list */}
                <p className="text-xs text-[#4a5f7f] font-light leading-relaxed min-h-[64px]">
                  {offer.services}
                </p>
                ...
                <div className="pt-3 mt-auto">
                  <Button
                    className="w-full bg-transparent border border-[#d4af37]/35 text-[#4a5f7f] hover:bg-[#d4af37] hover:border-[#d4af37] hover:text-white rounded-none h-12 text-[10px] font-bold tracking-[0.32em] uppercase transition-all duration-500 btn-luxury"
                  >
                    Book Package
                  </Button>
                </div>
