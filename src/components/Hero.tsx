      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(180deg, rgba(31,53,94,0.42) 0%, rgba(31,53,94,0.22) 40%, rgba(31,53,94,0.70) 85%, rgba(31,53,94,0.96) 100%)',
            }}
          />
        </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none"
            style={{
              background: 'linear-gradient(180deg, rgba(31,53,94,0.4) 0%, rgba(31,53,94,0.2) 40%, rgba(31,53,94,0.65) 80%, rgba(31,53,94,0.92) 100%)',
              zIndex: 3,
            }} />
        </motion.div>
        ...
        >
          ...
          >
            <p className="font-light leading-tight text-left"
              ...
              <span className="block text-[#f0ead6] tracking-tight"
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            >
              <span
                className="block text-[clamp(3.2rem,8vw,6.5rem)] font-light tracking-tight text-[#f0ead6]"
                style={{
                  fontFamily: "'Times New Roman', Times, serif",
