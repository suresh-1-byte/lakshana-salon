...
export function Experts() {
  return (
    <section id="experts" className="py-36 bg-[#f7f7f5] relative overflow-hidden">
      {/* Ambient blobs */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-headline font-light text-[#1f355e]"
          ...
          <p className="text-[#4a5f7f] font-light max-w-xl mx-auto leading-relaxed">
            ...
            return (
              ...
              >
                ...
                <div className="relative w-60 h-60 flex-shrink-0">
                  ...
                  <div className="relative w-60 h-60 rounded-full overflow-hidden border border-[#d4af37]/25 group-hover:border-[#d4af37]/60 transition-all duration-700 shadow-[0_20px_60px_rgba(31,53,94,0.12)]"
                    style={{ boxShadow: '0 20px 60px rgba(31,53,94,0.12), 0 0 0 0 rgba(212,175,55,0)' }}>
                    <Image
                      src={imageUrl}
                      alt={expert.name}
                      fill
                    ...
                    />
                    {/* Inner vignette */}
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#f7f7f5]/20 group-hover:to-transparent transition-all duration-700" />
                ...
                <div className="space-y-4 px-2">
                  <h3 className="font-headline text-xl font-medium text-[#1f355e] group-hover:text-[#d4af37] transition-colors duration-[400ms]">
                    {expert.name}
                  </h3>
                  <p className="text-[10px] uppercase tracking-[0.32em] font-bold text-[#4a5f7f] group-hover:text-[#d4af37] transition-colors duration-[400ms]">
                    {expert.title}
                  </p>
                  ...
                  <p className="text-xs text-[#4a5f7f] font-light leading-relaxed line-clamp-3 group-hover:line-clamp-none transition-all duration-500">
                    {expert.bio}
                  </p>
                </div>
              </motion.div>
