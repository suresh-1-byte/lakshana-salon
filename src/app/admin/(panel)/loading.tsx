  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="rounded-2xl overflow-hidden"
        style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(212,68,122,0.08)' }}>
        {/* Header */}
        <div className="h-10 px-4 flex items-center gap-4"
          style={{ background: 'rgba(212,68,122,0.05)', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
        ...
        {Array.from({ length: 7 }).map((_, i) => (
          <div key={i} className="h-14 px-4 flex items-center gap-4"
            ...
            <div className="h-5 w-20 rounded-full ml-auto" style={{ background: 'rgba(212,68,122,0.08)' }} />
          </div>
        ))}
      </div>
    </div>
