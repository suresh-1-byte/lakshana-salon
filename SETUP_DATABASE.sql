-- ============================================
-- LAKSHANA BEAUTY SALON CRM - DATABASE SETUP
...
CREATE POLICY "Allow all" ON photo_gallery FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all" ON whatsapp_messages FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all" ON google_sheets_sync_log FOR ALL USING (true) WITH CHECK (true);

-- =====================================================
-- DONE! All 16 tables created with RLS enabled
-- =====================================================
